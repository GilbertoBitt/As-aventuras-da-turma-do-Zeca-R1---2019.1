...
public class Manager_1_1B : MonoBehaviour, ISkippable
{
	[TabGroup("Geral")] public TextMeshProUGUI textTutorialComponent;
	[TabGroup("Geral")] public Transform bottomCardsParent;
	[TabGroup("Geral")] public Transform topCardsParent;
	...
	[TabGroup("1ª Ano")] public CardRandomizationGroup cardGroup;

	[TabGroup("1ª Ano")] [LabelText("Name Cards Prefab")] [SuffixLabel("1ª Ano")]
	public GameObject bottomCardsPrefab1;

	[TabGroup("1ª Ano")] [LabelText("Image Cards Prefab")] [SuffixLabel("1ª Ano")]
	public GameObject topCardsPrefab1;

	[LabelText("Cell Size 1ª Ano")] [TabGroup("1ª Ano")]
	public Vector2 cellsize_1ano;

	[LabelText("Cell Size Drag 1ª Ano")] [TabGroup("1ª Ano")]
	public Vector2 cellsizeDrag_1ano;

	[LabelText("Texto Acerto")] [TabGroup("1ª Ano")]
	public TextMeshProUGUI textRight1;

	[LabelText("Texto Erro")] [TabGroup("1ª Ano")]
	public TextMeshProUGUI textWrong1;

	[LabelText("Pontuação por acerto")] [TabGroup("1ª Ano")]
	public int scorePerRight1;

	[LabelText("Habilidade")] [TabGroup("1ª Ano")]
	public HabilidadeBNCCInfo Habilidade1;

	public DragCard_1_1B[] dragCards = new DragCard_1_1B[5];
	public CanvasGroup[] dragCardsCanvasGroup = new CanvasGroup[5];
	[TabGroup("Geral")] public GridLayoutGroup groupLayout;
	[TabGroup("Geral")] public GridLayoutGroup groupLayoutDrop;
	...
	[TabGroup("1ª Ano")] [LabelText("Sprites Escolhidos")] [SuffixLabel("1ª Ano")]
...
//	public GameObject panelFinalC;
	...
	[LabelText("Cell Size 2ª Ano")] [TabGroup("2ª Ano")]
	public Vector2 cellsize_2ano;

	[LabelText("Cell Size Drag 2ª Ano")] [TabGroup("2ª Ano")]
	public Vector2 cellsizeDrag_2ano;

	[LabelText("Texto Acerto")] [TabGroup("2ª Ano")]
	public TextMeshProUGUI textRight2;

	[LabelText("Texto Erro")] [TabGroup("2ª Ano")]
	public TextMeshProUGUI textWrong2;

	[LabelText("Pontuação por acerto")] [TabGroup("2ª Ano")]
	public int scorePerRight2;

	[LabelText("Habilidade")] [TabGroup("2ª Ano")]
	public HabilidadeBNCCInfo Habilidade2;

	[TabGroup("3ª Ano")] public int idGameDidatico3Ano;

	[TabGroup("3ª Ano")] [LabelText("Card Group 3ª Ano")]
	public CardRandomizationGroupAlternative cardGroup3Ano;

	[TabGroup("3ª Ano")] [LabelText("Drag (Bottom) Cards Prefab")] [SuffixLabel("3ª Ano")]
	...
	[LabelText("Cell Size 3ª Ano")] [TabGroup("3ª Ano")]
	public Vector2 cellsize_3ano;

	[LabelText("Cell Size Drag 3ª Ano")] [TabGroup("3ª Ano")]
	public Vector2 cellsizeDrag_3ano;

	[LabelText("Texto Acerto")] [TabGroup("3ª Ano")]
	public TextMeshProUGUI textRight3;

	[LabelText("Texto Erro")] [TabGroup("3ª Ano")]
	public TextMeshProUGUI textWrong3;

	[LabelText("Pontuação por acerto")] [TabGroup("3ª Ano")]
	public int scorePerRight3;

	[LabelText("Habilidade")] [TabGroup("3ª Ano")]
	public HabilidadeBNCCInfo Habilidade3;
	...
	private static readonly int PanelDesafioNumber = Animator.StringToHash("panelDesafioNumber");
	...
	IEnumerator correction()
	{
		...
		for (int i = 0; i < dropCardsLength; i++)
		{
			if (dropCards[i].characterSprite.idItem != dropCards[i].cardDraged.characterSprite.idItem)
			{
				...
				{
					LOG.SaveEstatistica(
						anoLetivo == 1 ? idGameDidatico1Ano : anoLetivo == 2 ? idGameDidatico2Ano : idGameDidatico3Ano,
						1, false);
				}
			}
			else
		...
		{
			if (dropCards[i] != null &&
			    dropCards[i].characterSprite.idItem != dropCards[i].cardDraged.characterSprite.idItem)
			{
				wrongs++;
		...
		while (times < wrongTextDuration)
		{
			...
			{
				//WrongCards[i].position = Vector3.Lerp(posFrom[i],posTo[i], repositionCurve.Evaluate (s));
				WrongCardComponent[i].cardDraged.RightOneTextComponent.transform.localPosition =
					Vector3.Lerp(new Vector3(0f, -10f, 0f), posOffsetText, wrongTextCurve.Evaluate(s));
				WrongCardComponent[i].cardDraged.RightOneTextComponent.color = Color.Lerp(new Color(1f, 1f, 1f, 0f),
					YellowColor, wrongTextCurve.Evaluate(s));
				WrongCardComponent[i].cardDraged.TextComponent.color =
					Color.Lerp(YellowColor, RedColor, wrongTextCurve.Evaluate(s));
			}
